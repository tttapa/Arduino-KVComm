...
// First include <AH/STL/cstddef> to determine if some version of STLport is in use as the std lib
...
// been detected, then include <AH/STL/utility> as it is about 
// the smallest of the std lib headers that includes real C++ stuff.
// Some std libs do not include their C++-related macros in <AH/STL/cstddef> 
