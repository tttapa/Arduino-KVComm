...
// Handles broken standard libraries better than <AH/STL/iterator>
    ...
    class array {
      ...
      public:
        ...
        static BOOST_CONSTEXPR bool rangecheck (size_type i) {
            ...
            return i >= size() ? []{ ERROR(F("array<>: index out of range"), 0x8122); }(), true : true;
        }
    ...
    class array< T, 0 > {
      ...
      public:
        ...
        static reference failed_rangecheck () {
                FATAL_ERROR(F("attempt to access element of an empty array"), 
                            0x8123);
