...
//  otherwise use the C library, the <AH/STL/cstddef> workaround is included here so
//  that ugly workaround code need not appear in many other boost headers.
//  NOTE WELL: This is a workaround for non-conforming compilers; <AH/STL/cstddef>
//  must still be #included in the usual places so that <AH/STL/cstddef> inclusion
//  works as expected with standard conforming compilers.  The resulting
//  double inclusion of <AH/STL/cstddef> is harmless.
